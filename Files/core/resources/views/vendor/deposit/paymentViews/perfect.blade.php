...
<body>
    <form action="https://perfectmoney.is/api/step1.asp" method="POST" id="payment_form">
        ...
        <input type="hidden" name="PAYMENT_URL" value="{{route('vendor.showDepositMethods')}}">
        <input type="hidden" name="PAYMENT_URL_METHOD" value="POST">
        <input type="hidden" name="NOPAYMENT_URL" value="{{route('vendor.showDepositMethods')}}">
        <input type="hidden" name="NOPAYMENT_URL_METHOD" value="POST">
        <input type="hidden" name="SUGGESTED_MEMO" value="{{Auth::guard('vendor')->user()->username}}">
