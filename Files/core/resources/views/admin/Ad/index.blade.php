  ...
  <main class="app-content">
     ...
     <div class="row">
        <div class="col-md-12">
          ...
          @else
            <div class="tile">
               <h3 class="tile-title float-left">Ads List</h3>
                        ...
                        @foreach ($ads as $ad)
                          <tr>
                             ...
                             <td data-label="Mobile">
                               <button type="button" class="btn btn-outline-primary" onclick="showImageInModal(event, {{$ad->id}})"><i class="fa fa-eye"></i> View</button>
