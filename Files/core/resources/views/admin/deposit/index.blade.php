                ...
                <table class="table">
                   ...
                   <tbody>
                     ...
                     <tr>
                        ...
                        <td data-label="Username"><a target="_blank" href="{{route('admin.vendorDetails', $deposit->vendor_id)}}">{{$deposit->vendor->shop_name}}</a></td>
                        ...
                        <td>
                          <button type="button" class="btn btn-outline-primary" onclick="showImageInModal(event, {{$deposit->id}})"><i class="fa fa-eye"></i> View</button>
                        </td>
                        @if (request()->path() != 'admin/deposit/acceptedRequests' && request()->path() != 'admin/deposit/rejectedRequests')
